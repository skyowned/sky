({
    init : function(component, event, helper) {
        var action = component.get("c.getEmployeeType");
	...
	create : function(component, event, helper) {
        ...
        if($A.util.isEmpty(candidate.Type__c) || $A.util.isUndefined(candidate.Type__c)){
        ...
        action.setCallback(this,function(a){
            ...
            if(state == "SUCCESS"){
                //Reset Form
                var newCandidate = {'sobjectType': 'Employee__c',
                                    'Name': '',
                                    'Designation__c': '',
                                    'Salary__c': '', 
                                    'Type__c': ''
